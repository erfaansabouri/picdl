            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="login-main d-flex align-items-center justify-content-center">
                        <form action="{{ route('auth.post-set-new-password') }}" method="post" class="login-box bg-white p-3 d-flex flex-column align-items-center justify-content-center">
                            @csrf
                            @method('post')
                            <x-error></x-error>
                            ...
                            <div class="w-100 py-3 mb-3">
                                <div class="input-group d-flex align-items-center mb-2 py-2">
                                    ...
                                    <input name="password" type="password" placeholder="رمز عبور " class="number-input">
                                    <span class="icon-eye-svgrepo-com1 show-pass"></span>
                                </div>
                                <div class="input-group d-flex align-items-center py-2">
                                    <span class="icon-key-svgrepo-com"></span>
                                    <input name="password_confirmation" type="password" placeholder="تکرار رمز عبور " class="number-input">
                                    <span class="icon-eye-svgrepo-com1 show-pass"></span>
                                </div>
                                <input type="hidden" value="{{ encrypt($user) }}" name="token">
                            </div>
