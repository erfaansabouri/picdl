<section class="sites-box">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="sites-box_inner box-section bg-white p-3">
                    <div class="sites-wrapper d-flex align-items-center justify-content-center flex-wrap">
                        <a href="#" class="sites-img d-flex align-items-center justify-content-center"><img src="{{ asset('assets/img/sites/123RF-logo.png') }}" alt=""></a>
                        <a href="#" class="sites-img d-flex align-items-center justify-content-center"><img src="{{ asset('assets/img/sites/envato-pty-ltd-vector-logo.png') }}" alt=""></a>
                        <a href="#" class="sites-img d-flex align-items-center justify-content-center"><img src="{{ asset('assets/img/sites/freepik.png') }}" alt=""></a>
                        <a href="#" class="sites-img d-flex align-items-center justify-content-center"><img src="{{ asset('assets/img/sites/Layer 595.png') }}" alt=""></a>
                        <a href="#" class="sites-img d-flex align-items-center justify-content-center"><img src="{{ asset('assets/img/sites/123RF-logo.png') }}" alt=""></a>
                        <a href="#" class="sites-img d-flex align-items-center justify-content-center"><img src="{{ asset('assets/img/sites/envato-pty-ltd-vector-logo.png') }}" alt=""></a>
                        <a href="#" class="sites-img d-flex align-items-center justify-content-center"><img src="{{ asset('assets/img/sites/freepik.png') }}" alt=""></a>
                    </div>
